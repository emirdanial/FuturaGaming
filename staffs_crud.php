...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_staffs_a159753_pt2(fld_staff_num, fld_staff_fname, fld_staff_lname,
...
if (isset($_POST['update'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_staffs_a159753_pt2 SET
...
if (isset($_GET['delete'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("DELETE FROM tbl_staffs_a159753_pt2 where fld_staff_num = :sid");
