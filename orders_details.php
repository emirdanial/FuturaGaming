...
<head>
  ...
  <title>Future Gaming Ordering System : Orders Details</title>
  <!-- Bootstrap -->
...
<?php include_once 'nav_bar.php'; ?>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a159753, tbl_staffs_a159753_pt2,
          tbl_customers_a159753_pt2 WHERE
          tbl_orders_a159753.fld_staff_num = tbl_staffs_a159753_pt2.fld_staff_num AND
          tbl_orders_a159753.fld_customer_num = tbl_customers_a159753_pt2.fld_customer_num AND
          fld_order_num = :oid");
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_platform']." ".$productrow['fld_product_name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a159753,
            tbl_products_a159753_pt2 WHERE
            tbl_orders_details_a159753.fld_product_num = tbl_products_a159753_pt2.fld_product_num AND
          fld_order_num = :oid");
          $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
          $oid = $_GET['oid'];
        $stmt->execute();
