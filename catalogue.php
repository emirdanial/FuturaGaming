 ...
 <?php include_once 'nav_bar.php'; ?>
        ...
        <div class="thumbnail">
          <img src="products/<?php echo $readrow['fld_product_image'] ?>" class="img-responsive">
              <div class="caption">
                ...
                <h4><a href="products_details.php?pid=<?php echo $readrow['fld_product_num']; ?>"><?php echo $readrow['fld_product_name']; ?></a>
                </h4>
    ...
    <div class="row">
      ...
      <nav>
          ...
          <?php } else { ?>
            <li><a href="a=catalogue.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
