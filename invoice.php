...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a159753, tbl_staffs_a159753_pt2,
      tbl_customers_a159753_pt2, tbl_orders_details_a159753 WHERE
      ...
      tbl_orders_a159753.fld_order_num = tbl_orders_details_a159753.fld_order_num AND
      tbl_orders_a159753.fld_order_num = :oid");
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Future Gaming Sdn. Bhd.</h4>
      </div>
